            ...
            for g1 in range(0, k1):
                for g2 in range(0, k2):
                   ...
                   # rho  = (1.+ 9./(1.+(10.*sqrt((x-0.5-0.25*0.)**2+(y-0.5)**2)*cos(arctan2(y-0.5,x-0.5-0.25*0.) -20.*((x-0.5-0.25*0.)**2+(y-0.5)**2)))**2) )
                    ...
                    #rho   = (1. + max( max(7./cosh( 4.*((x-sqrt(3)/2)**2+(y-0.)**2 - 2.4) )**2, 7./cosh( 5.*((x-sqrt(4)/2)**2+(y-0.5)**2 - (pi/2)**2) )**2), max(7./cosh( 4.*((x+sqrt(3)/2)**2+(y-0.)**2 - 2.6) )**2,7./cosh( 5.*((x+sqrt(3)/2)**2+(y-0.5)**2 - (pi/2)**2) )**2)) )
        ...
        for ie2 in range(0, ne2):
            ...
            for g1 in range(0, k1):
                for g2 in range(0, k2):
                    ...
                    rho  = Crho/(1. + max( max(7./cosh( 4.*((x-sqrt(3)/2)**2+(y-0.)**2 - 2.4) )**2, 7./cosh( 5.*((x-sqrt(4)/2)**2+(y-0.5)**2 - (pi/2)**2) )**2), max(7./cosh( 4.*((x+sqrt(3)/2)**2+(y-0.)**2 - 2.6) )**2,7./cosh( 5.*((x+sqrt(3)/2)**2+(y-0.5)**2 - (pi/2)**2) )**2)) )
